  ...
  this.angular.module('FloorPlan').directive('floor', function() {
    return {
      ...
      compile: function(element, attrs, link) {
        var assembleBedrooms, b, bathrooms, bedrooms, bedroomsLeft, bedroomsRight, clearBoth, createBathroom, createBedroom, createLivingroom, floor, _i, _j, _ref, _ref1;
...
\
      ');
        ...
        createBathroom = function(num) {
          var bathroom, door, placement, text;
          placement = '40px';
          door = 'left';
          if (num % 2 === 0) {
            placement = '0px';
